...
{
    // Oribinal FlexibleMessageBox (1.3) by Jörg Reichert (public@jreichert.de).
    // Modified FlexibleMessageBox (1.0) by Renzo Pigliacampo (hipnosis183.github.io), to meet personal needs.
    public class FlexibleMessageBox
    {
        ...
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, int width, int height, int lines)
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, icon, width, height, lines);
        }
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private void InitializeComponent()
            {
                ...
                this.richTextBoxMessage = new ExRichTextBox();
                ...
                this.richTextBoxMessage.Cursor = Cursors.Arrow;
                ...
                this.richTextBoxMessage.Location = new System.Drawing.Point(60, 26);
                ...
                this.button3.Location = new System.Drawing.Point(180, 78);
            ...
            private FlexibleMessageBoxForm()
            {
                ...
                TryParse<TwoLetterISOLanguageID>(CultureInfo.CurrentUICulture.TwoLetterISOLanguageName, out this.languageID);
            ...
            public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, int width, int height, int lines)
            {
                ...
                //Set the buttons visibilities and texts. Also set a default button.
                SetDialogButtons(flexibleMessageBoxForm, buttons, MessageBoxDefaultButton.Button3);
                ...
                //Calculate the dialogs start size (Try to auto-size width to show longest text row). Also set the maximum dialog size. 
                SetDialogSizesEx(flexibleMessageBoxForm, text, caption, width, height);
        ...
        #region .NET 3.5 Support

        /// <summary>
        /// Replace for Enum.TryParse, since it's only available from .NET 4.0 onwards.
        /// </summary>
    ...
    // ExRichTextBox by Reza Aghaei (reza-aghaei.com).
